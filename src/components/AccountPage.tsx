...
export function AccountPage({
  ...
  useEffect(() => {
    setProfile(loadLocalAccountProfile(user));
  }, [user]);
  ...
  const handlePasswordSave = () => {
    ...
    setPasswordMessage(
      "비밀번호 변경 UI 검증이 완료되었습니다. 실제 변경은 백엔드 연동 후 처리하면 됩니다.",
    );
  ...
  const handleLogoutAllSessions = () => {
    alert("모든 기기 로그아웃은 백엔드 API 연동 후 연결하면 됩니다.");
  };
        ...
        return (
          ...
          >
              ...
              {[
                {
                  ...
                  title: "분석 완료 알림",
                  desc: "영상 분석이 완료되면 알림을 받습니다.",
                },
                {
                  key: "performance" as const,
                  title: "주간 리포트 알림",
                  desc: "주간 경기 성과 요약 리포트를 받습니다.",
                },
                {
                  key: "marketing" as const,
                  title: "이벤트 및 공지 알림",
                  desc: "이벤트, 공지사항, 업데이트 소식을 받습니다.",
                },
              ].map(({ key, title, desc }) => (
            ...
            <div className="mt-8 flex items-center justify-between">
              ...
              <button
                type="button"
                onClick={() => saveBanner("알림 설정이 저장되었습니다.")}
                className="px-6 py-2 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-all shadow-md shadow-blue-100"
              >
                알림 설정 저장
              </button>
        ...
        return (
          ...
          >
              ...
              {[
                {
                  ...
                  icon: Smartphone,
                  title: "2단계 인증 사용",
                  desc: "로그인 시 추가 인증을 요구해 계정을 더 안전하게 보호합니다.",
                },
                {
                  key: "newLoginAlert" as const,
                  icon: Bell,
                  title: "새로운 로그인 알림",
                  desc: "새로운 기기나 브라우저에서 로그인하면 이메일 알림을 받습니다.",
                },
                {
                  key: "sessionProtect" as const,
                  icon: Shield,
                  title: "세션 보호 강화",
                  desc: "비정상적인 접속이 감지되면 재인증을 요구합니다.",
                },
            ...
            <div className="mt-8 flex items-center justify-between">
              ...
              <button
                type="button"
                onClick={() => saveBanner("보안 설정이 저장되었습니다.")}
                className="px-6 py-2 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-all shadow-md shadow-blue-100"
              >
                보안 설정 저장
              </button>
        ...
        return (
          ...
          >
            <div className="space-y-5">
              {[
                {
                  key: "autoPlayVideo" as const,
                  icon: MonitorPlay,
                  title: "영상 자동 재생",
                  desc: "영상 보기 페이지에서 영상을 자동으로 재생합니다.",
                },
                {
                  key: "emailNewsletter" as const,
                  icon: Mail,
                  title: "뉴스레터 및 운영 메일 수신",
                  desc: "서비스 소식과 운영 관련 이메일을 받습니다.",
                },
                {
                  key: "dataCollection" as const,
                  icon: CheckCircle2,
                  title: "사용 데이터 수집 동의",
                  desc: "서비스 품질 향상을 위한 익명 사용 데이터를 수집합니다.",
                },
              ].map(({ key, icon: Icon, title, desc }) => (
                <div key={key} className="flex items-center justify-between gap-4 py-2">
                  <div className="flex items-start gap-3">
            ...
            <div className="mt-8 flex items-center justify-between">
              ...
              <button
                type="button"
                onClick={() => saveBanner("서비스 이용 설정이 저장되었습니다.")}
                className="px-6 py-2 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-all shadow-md shadow-blue-100"
              >
                서비스 설정 저장
              </button>
