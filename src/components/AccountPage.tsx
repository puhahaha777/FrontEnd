...
export function AccountPage({
  ...
  useEffect(() => {
    const loaded = loadLocalAccountProfile(user);
    setProfile(loaded);
  }, [user]);
        ...
        return (
          ...
          >
            <div className="space-y-5">
              ...
              <div className="flex items-center justify-between gap-4 py-2">
                <div>
                  <p className="font-semibold text-gray-900">주간 리포트 알림</p>
                  <p className="text-sm text-gray-500">
                    주간 경기 성과 요약 리포트를 받습니다.
                  </p>
                </div>
                <SectionToggle
              ...
              <div className="flex items-center justify-between gap-4 py-2">
                <div>
                  <p className="font-semibold text-gray-900">이벤트 및 공지 알림</p>
                  <p className="text-sm text-gray-500">
                    이벤트, 공지사항, 업데이트 소식을 받습니다.
                  </p>
                </div>
                <SectionToggle
              ...
              <div className="flex items-center justify-between gap-4 py-2">
                ...
                <SectionToggle
                  ...
                  onClick={() =>
                    setSecuritySettings((prev) => ({
                      ...prev,
                      newLoginAlert: !prev.newLoginAlert,
                    }))
                  }
                />
              </div>
              ...
              <div className="flex items-center justify-between gap-4 py-2">
                ...
                <SectionToggle
                  ...
                  onClick={() =>
                    setSecuritySettings((prev) => ({
                      ...prev,
                      sessionProtect: !prev.sessionProtect,
                    }))
                  }
                />
              </div>
                ...
                <SectionToggle
                  ...
                  onClick={() =>
                    setServiceSettings((prev) => ({
                      ...prev,
                      autoPlayVideo: !prev.autoPlayVideo,
                    }))
                  }
                />
              </div>
              ...
              <div className="flex items-center justify-between gap-4 py-2">
                ...
                <SectionToggle
                  ...
                  onClick={() =>
                    setServiceSettings((prev) => ({
                      ...prev,
                      emailNewsletter: !prev.emailNewsletter,
                    }))
                  }
                />
              </div>
